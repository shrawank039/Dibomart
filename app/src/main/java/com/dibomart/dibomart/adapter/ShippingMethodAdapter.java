...
public class ShippingMethodAdapter extends RecyclerView.Adapter<ShippingMethodAdapter.MyViewHolder> {
    ...
    private final List<ShippingMethodList> moviesList;
   ...
   // private ProgressDialog pDialog;
    ...
    public ShippingMethodAdapter(Context context, List<ShippingMethodList> moviesList) {
        ctx = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_shipping_list, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final ShippingMethodList ongoing = moviesList.get(position);

        holder.name.setText(ongoing.getTitle());
        holder.charges.setText("Rs. "+ ongoing.getCharges());
